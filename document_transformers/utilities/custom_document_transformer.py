...
# TODO: add more transformers and splitters
...
# TODO:
#  - add metadata extra to put in transformed document
#  - use transformer class name instead of class instance
class TransformerConfig(BaseModel):
    ...
    input_store: Optional[Dict[str, Any]] = None  # New attribute for input store configuration
    output_store: Optional[Dict[str, Any]] = None  # New attribute for output store configuration


class CustomDocumentTransformer(BaseDocumentTransformer):
    """
    ...
    def serialize_metadata(metadata: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for key, value in metadata.items():
            if isinstance(value, ObjectId):
                ...
                serialized_metadata[key] = CustomDocumentTransformer.serialize_metadata(value)
            else:
...
'''
    ...
    # TODO: change in order to give only string of transformer class name instead of a class instance
    transformer_map = {
    ...
    transformer = CustomDocumentTransformer(transformer_map, default_transformer, default_kwargs)
